pub const HKDF_INFO_2SKD: &[u8] = b"stern-v1-2skd";
pub const HKDF_INFO_KEK: &[u8] = b"stern-v1-kek";
pub const HKDF_INFO_VERIFY: &[u8] = b"stern-v1-verify";
pub const HKDF_INFO_SYNC_AUTH: &[u8] = b"stern-v1-sync-auth";
